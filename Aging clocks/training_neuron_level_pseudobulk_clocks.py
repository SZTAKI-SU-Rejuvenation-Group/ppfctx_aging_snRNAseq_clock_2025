...
###
###
### training neuron-level simple pseudobulk aging clocks
###
###
...
for alpha in alphas:
    ...
    df_models.to_csv("clocks/pseudobulk_neuron_"+str(alpha)+".csv", index=False)
    df_final.to_csv("results/pseudobulk_neuron_"+str(alpha)+".csv", index=False)
    
###
###
### training neuron-level bootstrapped pseudobulk aging clocks (with 500 cells sampled)
###
###
...
for alpha in alphas:
    ...
    df_models.to_csv("clocks/pseudobulk_neuron_500_bootstrapped_"+str(alpha)+".csv", index=False)
    df_final.to_csv("results/predictions_pseudobulk_neuron_500_bootstrapped_"+str(alpha)+"_.csv")
    
###
###
### training neuron-level bootstrapped pseudobulk aging clocks (with 100 cells sampled)
###
###
...
for alpha in alphas:
    ...
    df_models.to_csv("clocks/pseudobulk_neuron_100_bootstrapped_"+str(alpha)+".csv", index=False)
    df_final.to_csv("results/predictions_pseudobulk_neuron_100_bootstrapped_"+str(alpha)+"_.csv")