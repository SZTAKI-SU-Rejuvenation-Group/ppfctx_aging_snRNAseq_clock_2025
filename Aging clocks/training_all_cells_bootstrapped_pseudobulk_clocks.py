...
###
###
### training all-cells bootstrapped pseudobulk aging clocks (sampling 500 cells)
###
###
...
for alpha in alphas:
    ...
    df_models.to_csv("clocks/pseudobulk_500_bootstrapped_"+str(alpha)+".csv", index=False)
    df_final.to_csv("results/predictions_pseudobulk_500_bootstrapped_"+str(alpha)+"_.csv")


###
###
### training all-cells bootstrapped pseudobulk aging clocks (sampling 100 cells)
###
###
...
for alpha in alphas:
    ...
    df_models.to_csv("clocks/pseudobulk_100_bootstrapped_"+str(alpha)+".csv", index=False)
    df_final.to_csv("results/predictions_pseudobulk_100_bootstrapped_"+str(alpha)+"_.csv")
